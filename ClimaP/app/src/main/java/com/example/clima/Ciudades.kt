...
import com.example.clima.databinding.ActivityCiudadesBinding
...
class Ciudades : AppCompatActivity() {
    ...
    private fun solicitudHTTPVolley(url: String) {
        ...
        val solicitud = StringRequest(Request.Method.GET, url, { response ->
            try {
                ...
                val gson = Gson()
                val ciudad = gson.fromJson(response, NombreCiudades::class.java)
    ...
    protected open fun actualizarVistas(ciudad: NombreCiudades) {
